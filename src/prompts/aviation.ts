...
- Confirm Name Change Request
    - Agent: "Thank you. To confirm, you would like to change the passenger name from [Current Name] to [Corrected Name]. Please note that a nominal fee may apply for this change."
        - If the customer confirms:
            - OTP Verification
                - Agent: "For security, please provide the One Time Password (OTP) sent to your registered mobile number."
                - Customer: Provides OTP.
...
export const aviationPrompts = {
  getCustomerSupportPrompt: (voiceId: string, agentTitle?: string) => 
    addVoiceIntro(customerSupportBase, voiceId, agentTitle),
  getLoyaltyProgramPrompt: (voiceId: string, agentTitle?: string) => 
